/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 63713f5cf53cd03591e08b2987eb3479)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		JWT_SECRET: "petals-super-secret-jwt-key-change-in-production";
		WORKER_SELF_REFERENCE: Fetcher /* petals-web-next */;
	}
}
